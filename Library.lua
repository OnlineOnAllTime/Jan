	...
	local library = {design = getgenv().design == "kali" and "kali" or "@cat", tabs = {}, draggable = true, flags = {}, title = "@cat", open = false, mousestate = inputService.MouseIconEnabled, popup = nil, instances = {}, connections = {}, options = {}, notifications = {}, tabSize = 0, theme = {}, foldername = "uw_configs", fileext = ".uw"}
